...
//instância -> se dá quando a criação de objetos
const pessoa1 = new Pessoa('Pedro', 'Henrique'); // <- Pessoa = função contrutora
const pessoa2 = new Pessoa('Henrique', 'Martin');// <- Pessoa = função contrutora

console.dir(pessoa1.nomeCompleto());
console.dir(pessoa2);


//Prototype é um objeto que já está atrelado ao JS
//Serve para evitar a criação de vários métodos identicos
